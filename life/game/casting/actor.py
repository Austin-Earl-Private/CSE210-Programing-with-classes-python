from week05.snake import constants
from week05.snake.game.shared.color import Color
from week05.snake.game.shared.point import Point
...
class Actor:
    ...
    def __init__(self):
        ...
        self._grid_pos = Point(0, 0)
        self._draw_square = False

    def is_square(self):
        return self._draw_square

    def set_draw_square(self, state):
        self._draw_square = state
    ...
    def get_grid_position(self):
        """Gets the actor's position in grid space.

        Returns:
            Point: The actor's position in grid space.
        """
